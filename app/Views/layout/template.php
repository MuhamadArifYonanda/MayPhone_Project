...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('/') ?>">
                ...
                <div class="sidebar-brand-text mx-3">MayPhone <sup>-_-</sup></div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Muhamad Arif Yonanda</span>
                                <img class="img-profile rounded-circle"
                                    src="sb2/img/profile.jpg">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; MayPhone 2025</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="sb2/vendor/sweetalert2/sweetalert2.min.js"></script>
    ...
    function confirmDelete(deleteUrl) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Redirect ke URL untuk menghapus
                window.location.href = deleteUrl;
            }
        });
    }

    // Flashdata notifikasi sukses
